...
public class TestDynamicArrayWithAddMethod {
    public static void main(String[] args) {
        DynamicArrayWithAddMethod da = new DynamicArrayWithAddMethod();
        da.add(1);
        da.add(2);
        da.add(3);
        da.add(4);
        ...
        // add an array to the end of the dynamic array
        int[] arrToAdd = {10, 11, 12};
        da.addArray(arrToAdd);

        // print Elements of array after adding an array
